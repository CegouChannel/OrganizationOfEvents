document.addEventListener("DOMContentLoaded", ()=>{
    let add_person = document.querySelector(".about_order")
    let black_bg = document.querySelector(".black_background")
    let modal_person = document.querySelector("div[name='window_about_event']")
    ...
    $(".about_order").click(function(event){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                let form = document.querySelectorAll("div[name='window_about_event'] > div > form > input")

                let fio = form[0]
                let phone = form[1]
                let type_event = form[2]
                let time = form[3]
                let script = document.querySelector(".script_event")

                fio.value = event.fio
                phone.value = event.phone
                type_event.value = event.type_event
                time.value = event.date
                script.value = event.fio
